...
function Post( {id, nameUser, userImg, img, caption,timestampPost}) {
   ...
   useEffect(() => {
    ...
    return (
        <div className = 'bg-white overflow-hidden my-8 shadow-2xl '>
            ...
            <div className = 'flex items-center p-5'>
                <div className = 'relative w-10 h-10'>
                    <Image blurDataURL = 'blur' layout = 'fill' src = {userImg} alt = 'userImage' className = ' rounded-full cursor-pointer p-1 border mr-5 ' />
                </div>
            ...
            <div className = 'containerImage relative flex items-center overflow-hidden transition-all'>
                <div className = 'relative w-full h-[32rem] cursor-pointer'>
                    {
                        img ? (
                            <LazyLoadImage src = {img}  className = 'absolute top-0 left-0 w-full h-full object-cover' />
                        ) : (
           ...
           {openModalComment ? (
               <div className = 'fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center overflow-hidden transition duration-1000 ease-in-out' onClick = {closeModal}>
                   <Fade>
                       <div className = 'flex flex-wrap md:flex-nowrap md:w-4/4 md:h-4/4 w-3/4 h-2/3'>
                       ...
                       <div className = 'flex w-full h-2/3 md:w-1/4 md:h-full flex-col bg-gradient-to-tr from-bg-pink-50 to-bg-red-50 overflow-hidden'>
                           ...
                           <div className = 'flex flex-col h-2/3 p-4 overflow-y-auto scrollbar-thin border-b-2'>
                           ...
                           <form onSubmit={sendComment} className = 'flex items-center px-4 md:py-6 py-1'>
                                <EmojiHappyIcon className = 'w-8 text-gray-500 cursor-pointer' />
