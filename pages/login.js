          ...
          <div className = ' grid grid-cols-1 md:grid-cols-2 px-4 max-w-3xl md:max-w-6xl md:mx-auto lg:mx-auto  overflow-hidden z-20'>
                ...
                <div className = 'flex items-center justify-center'>
                        <div className = 'relative coloredBorder shadow-xl rounded-md p-16 w-96 flex flex-col justify-center items-center cursor-pointer bg-gray-50 hover:coloredBorderReversed z-20'>
                            ...
                            <div>
                                <button onClick = {signInUser}  className = 'flex-1 w-full px-4 mt-4 py-2  flex items-center gap-6 justify-center  bg-red-400 rounded-full text-white cursor-pointer hover:scale-105 transition-all transform duration-500 ease-out' type = 'button'>
                                    Login with Google
                                ...
                                <FacebookProvider appId="611691100256572">
                                            <LoginButton
                                            className = 'flex-1 w-full px-4 mt-4 py-2  flex items-center justify-center  bg-blue-400 rounded-full text-white cursor-pointer hover:scale-105 transition-all transform duration-500 ease-out'
                                                scope="email"
